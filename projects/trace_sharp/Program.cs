...
var renderSpheres = new RenderableEntity[]
{
    ...
    RenderableEntity.CreateSphere(new float3( 0.0f,  0.3f,  -3.0f), new float3(0, 1, 1), 0.18f, 0.5f),
    RenderableEntity.CreateSphere(new float3( 8.0f,  0.0f, -10.0f), new float3(0, 1, 0), 0.18f, 1.0f),
    RenderableEntity.CreateSphere(new float3(-8.0f, -4.0f, -16.0f), new float3(0, 0, 1), 0.18f, 1.0f)
};
